...
class SoBaseColor(SoNode):
    def __init__(self) -> None: ...
    @property
    def rgb(self) -> SoMFColor: ...
    @rgb.setter
    def rgb(self, v: SoMFColor): ...
...
class SoNoIndexedShape(SoVertexShape):
    def __init__(self) -> None: ...

class SoLineSet(SoNoIndexedShape):
    def __init__(self) -> None: ...
...
class SoMFVec3f(SoMField):
    ...
    @overload
    def setValues(
        self, start: int, num: int, newVals: Sequence[Sequence[float]]
    ) -> None: ...
    @overload
