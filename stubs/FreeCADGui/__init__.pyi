from typing import Union, Any, Optional, Union, overload
from PySide2.QtWidgets import QMainWindow, QWidget
from typing_extensions import Protocol
from . import PySideUic

from FreeCAD import Document

from pivy.coin import SoCamera, SoNode, SoSeparator
import DraftGui
...
def doCommand(source: str) -> None: ...
def doCommandGui(source: str) -> None: ...
def addModule(module_name: str) -> None: ...
def showDownloads() -> None: ...
def showPreferences() -> None: ...
@overload
def createViewer(split: int) -> SplitView3DInventor:
    ...
    ...
@overload
def createViewer() -> View3DInventor:
    """createViewer([int]) -> View3DInventor/SplitView3DInventor
    shows and returns a viewer. If the integer argument is given and > 1: -> splitViewer"""
    ...
...
class View3DInventorViewer():
    ...
    def setSceneGraph(self, s: SoNode) -> None: ...
    def setBackgroundColor(self, c1, c2, c3) -> None: ...


# View3DPy.cpp
class View3DInventor:
    def __init__(self): ...
    def getViewer(self) -> View3DInventorViewer: ...
    def getCameraNode(self) -> SoCamera: ...
    def getViewDirection(self): ...
    def getSceneGraph(self) -> SoSeparator: ...
    def fitAll(self): ...
    def setCameraType(self, camera_type: str): ...
    def setCamera(self, camera_data): ...
    def setCameraOrientation(self, camera_orientation): ...
    def saveVectorGraphic(self, file, n): ...
    def setName(self, name: str): ...
    def redraw(self): ...

# View3DPy.cpp
class SplitView3DInventor(View3DInventor):
    pass
...
draftToolBar: Union[DraftGui.DraftToolBar, None]
Snapper: SnapperClass
...
class UiLoader:
    ...
    def createWidget(self, class_name: str) -> Any: ...
